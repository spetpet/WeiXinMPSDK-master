...
namespace Senparc.Weixin.QY
{
    public static class Signature
    {
        ...
        /// </summary>
        public const string Token = "gywl8888";
        /// <summary>
        /// 在网站没有提供EncodingAESKey（或传入为null）的情况下的默认Token，建议在网站中进行配置。
        /// </summary>
        public const string EncodingAESKey = "IRf7deIlfxhYLCfEkTakILTXePek6GHIrPjSc7cIWKQ";
        /// <summary>
        /// 在网站没有提供CorpId（或传入为null）的情况下的默认Token，建议在网站中进行配置。
        /// </summary>
        public const string CorpId = "wx9b25d5460920c234";
