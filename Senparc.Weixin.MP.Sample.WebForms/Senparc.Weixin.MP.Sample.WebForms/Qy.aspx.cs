...
namespace Senparc.Weixin.MP.Sample.WebForms
{
    ...
    {
        public static readonly string Token = "gywl8888";//与微信企业账号后台的Token设置保持一致，区分大小写。
        public static readonly string EncodingAESKey = "IRf7deIlfxhYLCfEkTakILTXePek6GHIrPjSc7cIWKQ";//与微信企业账号后台的EncodingAESKey设置保持一致，区分大小写。
