...
namespace Senparc.Weixin.MP.Sample.WebForms
{
    ...
    {
        private readonly string Token = "gywl8888";//与微信公众账号后台的Token设置保持一致，区分大小写。
        private readonly string CROPID = "wx9b25d5460920c234";
        private readonly string ENCODINGAESKEY = "IRf7deIlfxhYLCfEkTakILTXePek6GHIrPjSc7cIWKQ";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.HttpMethod == "GET")
            {
                ...
                WriteContent(Signature.VerifyURL(Token, ENCODINGAESKEY, CROPID, msg_signature, timestamp, nonce, echostr));
            ...
            else
            {
                ...
                if (!CheckSignature.Check(msg_signature, timestamp, nonce, Token))
                {
                    WriteContent("参数错误！");
                    return;
                }
                ...
                var postModel = new PostModel()
                {
                    ...
                    Token = Token,
                    EncodingAESKey = "IRf7deIlfxhYLCfEkTakILTXePek6GHIrPjSc7cIWKQ",//根据自己后台的设置保持一致
                    AppId = "wx9b25d5460920c234"//根据自己后台的设置保持一致
                };
